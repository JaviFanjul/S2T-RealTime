...
run:
	 docker run --rm -it -v $(AUDIO_VOLUME):/audiofiles_volume -v $(CHUNKS_VOLUME):/audiochunks_volume -v $(LOGS_VOLUME):/audiotranscription_volume  $(IMAGE_NAME) python s2t.py ../audiofiles_volume/llamada1.wav
